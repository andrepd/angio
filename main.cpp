...
/*
   ...
   const double medini = -0.2
   const double ge = 0.126; mu1 rigidez da matriz 
   const double Amp = 10.55;  // Amplitude da forca
   const double D = 11; Constante de difusao de vegf
   const double dt = 0.02;  // Passo de tempo
   const int    rad = 5;  // Raio das celulas
   const double vbase = 0.01;
   const double valoralfa = 0.065; adesao das celulas
